...
const static char *kDonatePool1   = "pool.ngin.cash";
...
DonateStrategy::DonateStrategy(int level, const char *user, int algo, IStrategyListener *listener) :
    ...
    m_listener(listener)
{
    m_pools.push_back(new Url(kDonatePool1, 3333, "0x37026e8a17ece4535cad34efc29834e589c40818", nullptr, false, false));
